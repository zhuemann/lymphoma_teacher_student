...
if __name__ == '__main__':
    ...
    for seed in seeds:
        teacher_student_train(seed=seed, batch_size=4, epoch=1, dir_base=directory_base, n_classes=5)
        acc, matrix = train_vision_model(seed=seed, batch_size=4, epoch=1, dir_base=directory_base, n_classes=5)
